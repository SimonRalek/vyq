...
pub const Block = struct {
    ...
    pub const OpCode = enum(u8) { op_value, op_ano, op_ne, op_nic, op_not, op_negate, op_equal, op_greater, op_less, op_shift_left, op_shift_right, op_bit_and, op_bit_or, op_bit_xor, op_bit_not, op_add, op_sub, op_mult, op_div, op_increment, op_decrement, op_return, op_print, op_println, op_def_glob_var, op_def_glob_const, op_get_glob, op_set_glob, op_get_loc, op_set_loc, op_pop, op_popn, op_jmp, op_jmp_on_true, op_jmp_on_false, op_loop, op_case, op_call };
